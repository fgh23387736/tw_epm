			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#menuProject" data-toggle="collapse" class="<% if(url_page.equals("projects")||url_page.equals("project")) out.print("active");else out.print("collapsed");%>"><i class="lnr lnr-layers"></i> <span>项目管理</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
						...
						<c:if test="${user.type == 2}">
						  	<li><a href="/tw_epm/end/admin/user/users.jsp" class="<% if(url_page.equals("user")) out.print("active");%>"><i class="lnr lnr-users"></i> <span>人员管理</span></a></li>
						</c:if>
