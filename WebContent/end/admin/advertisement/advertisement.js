var pageListPath="/sanhe/src/v1/advertisement/advertisement.php";
...
pageListmanage.init({
	...
	drawDatatoCotent:function (data){
			...
			+"</td><td>"+data.Id
            +"</td><td><img src='"+this.checkTypedof(data.ImgUrl)+"' height='80'>"
            +"</td><td>"+this.checkTypedof(data.Url)
			+"</td><td>"+"<button type='button' class='btn btn-danger  btn-sm' onclick='pageListDeleteOne("+data.Id+")'>删除</button>"
			+"</td></tr>";
			return allstr;
	}
});
